...
var template = new Faker<Staff>()
    ...
    .RuleFor(o => o.DateOfBirth, f => f.Date.Between(DateTime.Now.AddYears(-30), DateTime.Now.AddYears(-20)))
    .RuleFor(o => o.Salary, f =>
    {
        int randomNumber = random.Next(1000000, 1000000000);
        var result = randomNumber.ToString().Substring(0, 1) + "0".PadLeft(randomNumber.ToString().Length - 1, '0');
